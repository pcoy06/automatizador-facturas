...
export async function POST(request: Request) {
  try {
    ...
    // Use 'form-data' library for reliable multipart handling in Node.js
    ...
    // Append to form-data with explicit filename and content-type
    ...
    // We must pass the headers generated by form-data to fetch
    const response = await fetch(webhookUrl, {
      method: 'POST',
      body: form as any, // Cast to any because node-fetch types mismatch with native fetch
      headers: {
        'miapikey': apiKey,
        ...form.getHeaders(), // Critical: adds the correct boundary
      },
    });
